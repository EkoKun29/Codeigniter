...
gulp.task('copyAddonsScripts', function() {
    ...
    var aScript36 = gulp.src(['node_modules/clockpicker/dist/jquery-clockpicker.min.js'])
        .pipe(gulp.dest('./vendors/clockpicker'));
    ...
    var aScript66 = gulp.src(['node_modules/sweetalert2/dist/sweetalert2.min.js'])
    ...
    var aScript75 = gulp.src(['node_modules/icheck/icheck.min.js'])
        .pipe(gulp.dest('./vendors/icheck'));
    var aScript76 = gulp.src(['node_modules/bootstrap-tour/build/js/bootstrap-tour-standalone.min.js'])
        .pipe(gulp.dest('./vendors/bootstrap-tour'));
    var aScript77 = gulp.src(['node_modules/bootstrap-tour/build/js/bootstrap-tour-standalone.min.js'])
        .pipe(gulp.dest('./vendors/bootstrap-tour'));
    return merge(aScript1, aScript2, aScript3, aScript4, aScript5, aScript6, aScript7, aScript8, aScript9, aScript10, aScript11, aScript12, aScript13, aScript14, aScript15, aScript16, aScript17, aScript18, aScript19, aScript20, aScript21, aScript22, aScript23, aScript24, aScript25, aScript26, aScript27, aScript28, aScript29, aScript30, aScript31, aScript32, aScript33, aScript34, aScript35, aScript36, aScript37, aScript38, aScript39, aScript40, aScript41, aScript42, aScript43, aScript44, aScript45, aScript46, aScript47, aScript48, aScript49, aScript50, aScript51, aScript52, aScript53, aScript54, aScript55, aScript56, aScript57, aScript58, aScript59, aScript60, aScript61, aScript62, aScript63, aScript64, aScript65, aScript66, aScript67, aScript68, aScript69, aScript70, aScript71, aScript72, aScript73, aScript74, aScript75, aScript76);
});
...
gulp.task('copyAddonsStyles', function() {
    ...
    var aStyle2 = gulp.src(['./node_modules/mdi/fonts/*'])
    ...
    var aStyle28 = gulp.src(['node_modules/jquery-file-upload/css/uploadfile.css'])
        .pipe(gulp.dest('./vendors/jquery-file-upload'));
    var aStyle29 = gulp.src(['node_modules/clockpicker/dist/jquery-clockpicker.min.css'])
        .pipe(gulp.dest('./vendors/clockpicker'));
    ...
    var aStyle52 = gulp.src(['node_modules/ion-rangeslider/img/*'])
        ...
        var aStyle53 = gulp.src(['node_modules/pwstabs/assets/jquery.pwstabs.min.css'])
        .pipe(gulp.dest('./vendors/pwstabs'));
    var aStyle54 = gulp.src(['node_modules/icheck/skins/**/*'])
        .pipe(gulp.dest('./vendors/icheck/skins'));
    var aStyle55 = gulp.src(['node_modules/bootstrap-tour/build/css/bootstrap-tour-standalone.min.css'])
        .pipe(gulp.dest('./vendors/bootstrap-tour'));
    var aStyle56 = gulp.src(['node_modules/bootstrap-table/dist/bootstrap-table.min.css'])
        .pipe(gulp.dest('./vendors/bootstrap-table'));
    var aStyle57 = gulp.src(['node_modules/sweetalert2/dist/sweetalert2.min.css'])
        .pipe(gulp.dest('./vendors/sweetalert2'));
