...
class Test extends CI_Controller
{
	...
	public function index()
	{
		...
		{
			$telegrambot = '1803841691:AAGBj79NUD_xZ2F4kFxG7LcIFiU7g7dSVr0';
			$telegramchatid = 1255020568;
			global $telegrambot, $telegramchatid;
			$url = 'https://api.telegram.org/bot' . $telegrambot . '/sendMessage';
			$data = array('chat_id' => $telegramchatid, 'text' => $msg);
			$options = array('https' => array('method' => 'POST', 'header' => "Content-Type:application/x-www-form-urlencoded\r\n", 'content' => http_build_query($data),),);
