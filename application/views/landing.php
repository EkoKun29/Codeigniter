...
<head>
    ...
    <!-- Favicons -->
    <link href="<?= base_url('data modul/Regna/'); ?>assets/img/favicon.png" rel="icon">
    <link href="<?= base_url('data modul/Regna/'); ?>assets/img/apple-touch-icon.png" rel="apple-touch-icon">
