    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-md-center">
                        <i class="fa fa-home icon-lg text-primary"></i>
                        <div class="ml-3">
                            <p class="mb-0">Jumlah Kecamatan</p>
                            <h6><?php echo $jumlahkec; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-lg-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-md-center">
                        <i class="fa fa-home icon-lg text-warning"></i>
                        <div class="ml-3">
                            <p class="mb-0">Jumlah Desa</p>
        ...
        <div class="col-md-6 col-lg-3 grid-margin stretch-card">
            <div class="card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-md-center">
                        <i class="fa fa-group icon-lg text-danger"></i>
                        <div class="ml-3">
                            <p class="mb-0">Jumlah Pegawai</p>
                            <h6><?php echo $jumlahpegawai; ?></h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center justify-content-md-center">
                        ...
                        <div class="ml-3">
                            <p class="mb-0">Total Permohonan Gaji</p>
                            <h6><?php echo $this->angka->rupiah($totalpermohonan); ?></h6>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-9 grid-margin stretch-card">
            <div class="card">
                <div class="card-body" style="width: 100%; left:200px;">
                    <h4 class="card-title">Grafik Permohonan</h4>
