        ...
        <div class="card-body">
          ...
          <form class="forms-sample" action="<?=base_url("sistem/group_do/$sub")?>" method="post">
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">Name Group</label>
               <div class="col-sm-6">
                  <input name="GroupName" type="text" placeholder="Nama Group" class="form-control" value="<?=$group['GroupName']?>">
               </div>
            </div>
            <div class="form-group row">
              <label class="col-sm-3 col-form-label">Keterangan</label>
                <div class="col-sm-6">
                  <input name="GroupDescription" type="text"  placeholder="Keterangan" class="form-control" value="<?=$group['GroupDescription']?>">
                </div>
            </div>
            <div class="form-group row">
