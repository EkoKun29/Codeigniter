...
<body>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-top justify-content-center" style="background-color: #0072ff" ; ">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center" style="  background: linear-gradient(to right, #0072ff, #00c6ff);">
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <!-- partial style="background-image: linear-gradient(to top, #00c6fb 0%, #6a11cb 100%);"-->
        <div class="container-fluid page-body-wrapper">
          <div class="row row-offcanvas row-offcanvas-right">
            <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color: #0072ff; font-weight: bold;">
              <div class="nav">
                <li class="nav-item nav-profile">
                  <div class="nav-link">
                    <a href="<?= base_url('changepassword'); ?>">
                      <div class="profile-image">
                        <img src="<?= base_url('img') ?>/user1.png" alt="image" />
                ...
                <li class="nav-item <?php if ($this->uri->segment(2) == "dashboard") {
                  ...
                  <a class=" nav-link" href="<?= base_url('home/dashboard') ?>" style="color:white;">
